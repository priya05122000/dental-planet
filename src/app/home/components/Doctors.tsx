        ...
        <div className='py-10 sm:py-16'>
            <CenterSection>
                ...
                <div className='grid grid-cols-2 relative'>
                    <div>
                        <div className='flex'>
                            <div className='bg-primary/10  h-32 w-40 '>
                                <Image
                            ...
                            <div className='bg-primary/10 p-4 h-32 w-full'>
                    ...
                    <div className='absolute top-32 w-1/2 left-1/3'>
                        <div className='flex'>
                            ...
                            <div className='bg-primary p-4 h-32 w-full'>
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti, non!
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='absolute top-96 w-1/2 left-40'>
                        <div className='flex'>
                            <div className='bg-primary/10  h-32 w-40 '>
                                <Image
                                    src="/services/dental-clinic.webp"

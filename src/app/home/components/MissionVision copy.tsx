    ...
    return (
        <>
            ...
            >
                ...
                <div className="absolute bottom-0 right-16 flex gap-3 z-20">

                    <button className="custom-prev cursor-pointer  p-2 flex items-center justify-center rounded bg-washed-black/58 text-white transition" onClick={() =>
                            scrollToIndex(Math.max(activeIndex - 1, 0))
                        }>
                        <IoIosArrowBack />
                    </button>

                    <button className="custom-next text-white cursor-pointer p-2 flex items-center justify-center rounded  bg-primary  transition"    onClick={() =>
